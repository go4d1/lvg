...
***            Lvg.ini and you can customize operation there.
***
***            [ServerConfig]
***            Virtual=Lvg            
***            ScriptMaps=wc,wcs,wcsx,wc    
...
***
***    Assume: Called from LvgMain.prg startup code
***            with lcAction parameter:
***            DO LvgMain with "CONFIG"
***
***            Or launch your Exe from the Windows Command Line:
***            Lvg.exe config
***
***            or with a specific IIS site/virtual
***            Lvg.exe config "IIS://localhost/w3svc/12/root"
***
...
*** Try to read from Lvg.ini [ServerConfig] section
