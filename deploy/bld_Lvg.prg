...
EXE_FILE		  =		  	"Lvg"
DCOM_ProgId       =			"Lvg.LvgServer"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Lvg/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Lvg/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Lvg/wc.wc?wwmaint~FileUpload"
